 ...
 * @constructor
 */
var ProtractorExpectedConditions = function (browser) {
 ...
 */
ProtractorExpectedConditions.prototype.and = function (...args) {
 ...
 */
ProtractorExpectedConditions.prototype.or = function (...args) {
...
ProtractorExpectedConditions.prototype.elementToBeClickable = function (elementFinder) {
  return this.and(this.visibilityOf(elementFinder), () => {
    return elementFinder.isEnabled().then(util.passBoolean, util.falseIfMissing);
  });
};
...
ProtractorExpectedConditions.prototype.visibilityOf = function (elementFinder) {
  return this.and(this.presenceOf(elementFinder), () => {
    return elementFinder.isDisplayed().then(util.passBoolean, util.falseIfMissing);
  });
};
...
ProtractorExpectedConditions.prototype.elementToBeSelected = function (elementFinder) {
  return this.and(this.presenceOf(elementFinder), () => {
    return elementFinder.isSelected().then(util.passBoolean, util.falseIfMissing);
  });
};

module.exports = {
  ProtractorExpectedConditions: ProtractorExpectedConditions
};
