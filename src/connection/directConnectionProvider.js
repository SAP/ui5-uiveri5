 ...
 */
DirectConnectionProvider.prototype.setupEnv = function(runtimes) {
  this.logger.debug('Setting up connection provider environment');
  var that = this;
...
DirectConnectionProvider.prototype.buildDriverProvider = function (protConfig) {
  return new DirectDriverProvider(protConfig, this.logger, this.seleniumConfig);
};
